Contributing to AMMOcoin Core
============================

The AMMOcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ammocoin-project/ammocoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the AMMOcoin Core project, and is not to be
confused with overall AMMOcoin Network Protocol consensus changes.

Whether a pull request is merged into AMMOcoin Core rests with the project merge
...
Patches that change AMMOcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the AMMOcoin consensus, it must have been
...
The project leader is the release manager for each AMMOcoin Core release.
