...
// Wallet
    ...
    if (settings.contains("nAnonymizeAMMOcoinAmount"))
        SoftSetArg("-anonymizeammocoinamount", settings.value("nAnonymizeAMMOcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in ammocoin.cpp during shotdown to also remove the window positions
