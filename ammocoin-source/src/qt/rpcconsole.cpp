                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzAMMOPathCustom = GetArg("-zammobackuppath", "");
    ...
    if(!strzAMMOPathCustom.empty()) {
        ui->wallet_customzammobackuppath->setText(QString::fromStdString(strzAMMOPathCustom));
        ui->wallet_customzammobackuppath_label->setVisible(true);
        ui->wallet_customzammobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzAMMOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the AMMOcoin RPC console.") + "<br>" +
