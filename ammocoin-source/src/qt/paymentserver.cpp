...
const char* BIP71_MIMETYPE_PAYMENT = "application/ammocoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ammocoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ammocoin-paymentrequest";
...
//
// OSX-specific way of handling ammocoin: URIs and
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in ammocoin: URIs
...
bool PaymentServer::processPaymentRequest(PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    foreach (const PAIRTYPE(CScript, CAmount) & sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Insecure payments to custom ammocoin addresses are not supported
