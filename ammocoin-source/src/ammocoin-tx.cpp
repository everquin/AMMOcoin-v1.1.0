...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AMMOcoin Core ammocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ammocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ammocoin transaction") + "\n" +
                               "  ammocoin-tx [options] -create [commands]   " + _("Create hex-encoded ammocoin transaction") + "\n" +
                               "\n";
