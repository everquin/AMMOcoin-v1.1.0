...
extern UniValue DoZammoSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzammoseed(const UniValue& params, bool fHelp);
extern UniValue getzammoseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzammo(const UniValue& params, bool fHelp);
extern UniValue dzammostate(const UniValue& params, bool fHelp);
