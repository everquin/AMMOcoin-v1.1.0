...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AMMOcoin features */
        {"ammocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ammocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ammocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ammocoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ammocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ammocoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ammocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ammocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ammocoin", "startmasternode", &startmasternode, true, true, false},
        {"ammocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ammocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ammocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ammocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ammocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ammocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ammocoin", "preparebudget", &preparebudget, true, true, false},
        {"ammocoin", "submitbudget", &submitbudget, true, true, false},
        {"ammocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ammocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ammocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ammocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ammocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ammocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ammocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ammocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ammocoin", "mnsync", &mnsync, true, true, false},
        {"ammocoin", "spork", &spork, true, true, false},
        {"ammocoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzammoseed", &getzammoseed, false, false, true},
        {"zerocoin", "setzammoseed", &setzammoseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzammo", &searchdzammo, false, false, true},
        {"zerocoin", "dzammostate", &dzammostate, false, false, true},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37019/\n";
}
