...
#ifndef AMMOcoin_ZAMMOWALLET_H
#define AMMOcoin_ZAMMOWALLET_H
...
public:
    CzAMMOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAMMO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAMMO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
