...
#ifndef AMMOcoin_ZAMMOTRACKER_H
#define AMMOcoin_ZAMMOTRACKER_H
...
public:
    CzAMMOTracker(std::string strWalletFile);
    ~CzAMMOTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzAMMOWallet* zAMMOWallet = NULL);
