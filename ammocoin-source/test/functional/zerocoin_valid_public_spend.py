...
from fake_stake.base_test import AMMOcoin_FakeStakeTest

class zAMMOValidCoinSpendTest(AMMOcoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zAMMOs..." % DENOM_TO_USE)
